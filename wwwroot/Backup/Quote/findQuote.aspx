...
<asp:Label ID="Label1" runat="server" Text="Find Quotes" CssClass="heading"></asp:Label>
    ...
    <tr>
       <td align="left" colspan=3>
              <telerik:RadGrid ID="RadGrid1" runat="server" AllowFilteringByColumn="False" AllowPaging="True"  AllowSorting="True" AutoGenerateColumns="False" GridLines="None" Width="100%" >
