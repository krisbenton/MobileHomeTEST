 ...
 <table cellpadding="0" cellspacing="0">
                        <tr align="left">
                            <td>
                                ...
                                <asp:Button ID="btnLogout" runat="server" style="top: 0px; left: -15px; width:100px; height:30px; border: 1px solid #808080;" Text="Logout" OnClientClick="redirectFind3(); return false;" CausesValidation="false"  />
                            </td>
                        </tr>
    </table>
</asp:Content>
