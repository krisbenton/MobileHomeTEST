...
Public Class quote
    ...
    Public Sub LoadQuote(ByVal quoteID As String)
        Dim ds As System.Data.DataSet
        ds = Common.runQueryDS("SELECT * FROM tblQuotes q LEFT JOIN (SELECT DISTINCT AgencyID,AgencyCode,AgencyName FROM wrwpaqbx_ColonialWeb.wrwpaqbx_admin.vwAgents )vwag ON q.agencyName = vwag.AgencyName WHERE QuoteID = '" & quoteID & "'")
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            txtDOB.Text = dbdate.tostring("MM/dd/yyyy")
    ...
    Public Sub LoadAROptions(ByVal quoteID As String)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            ar_total1.Text() = ds.Tables(0).Rows(0).Item("ARPackageTotal")
    ...
    Public Sub updateQuote(ByVal quoteID As String)
        ...
        tsql += "agencyName =  '" & lblAgency.Text & "',"
        tsql += "agentName =  '" & txtAgConName.Text & "',"
        tsql += "agentEmail =  '" & txtConEmail.Text & "',"
        tsql += "effDate =  '" & txtEffDate.Text & "',"
        tsql += "applicantFirstName =  '" & txtAppFirstName.Text & "',"
        tsql += "applicantLastName =  '" & txtAppLastName.Text & "',"
        tsql += "applicantEmail =  '" & txtAppEmail.Text & "',"
        tsql += "applicantDOB =  '" & txtDOB.Text & "',"
    ...
    Public Sub save()
        ...
        Else
            ...
            tsql += " '" & lblAgency.Text & "',"
            tsql += " '" & txtAgConName.Text & "',"
            tsql += " '" & txtConEmail.Text & "',"
            tsql += " '" & txtEffDate.Text & "',"
            ...
            tsql += " '" & txtAppFirstName.Text & "',"
            tsql += " '" & txtAppLastName.Text & "',"
    ...
    Protected Sub calc()
        ...
        Else
            ...
            If supheatdd.SelectedValue = "No" Or (supheatdd.SelectedValue = "Yes" And (supHeatTypedd.SelectedValue.ToString = " " Or supHeatTypedd.SelectedValue.ToString = "Woodstove installed by a licensed contractor" Or supHeatTypedd.SelectedValue.ToString = "Fireplace installed by the manufacturer of licensed contractor")) Then
                supHeatIngel = True
            Else
                supHeatIngel = False
            End If
    ...
    Public Sub calcAR()
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            standardPremium = FormatCurrency(ds.Tables(0).Rows(0).Item("StandardRate").ToString)
            standardOtherStructures = FormatCurrency(ds.Tables(0).Rows(0).Item("StandardStructureRate").ToString)
            standardContents = FormatCurrency(ds.Tables(0).Rows(0).Item("StandardPersonalPropRate").ToString)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            rentalPremium = FormatCurrency(ds.Tables(0).Rows(0).Item("RentalRate").ToString)
            rentalOtherStructures = FormatCurrency(ds.Tables(0).Rows(0).Item("StructureRate").ToString)
            rentalContents = FormatCurrency(ds.Tables(0).Rows(0).Item("PersonalPropRate").ToString)
        ...
        AR1_Debug.Text += "<tr align=left><td> Credits Value</td><td>" & (packagePremium * CreditsPercentage) & " </td></tr> "
        packageTotal = (packagePremium - (packagePremium * CreditsPercentage))
        'Standard
        AR2_Debug.Text += "<tr align=left><td> Credits %</td><td> " & CreditsPercentage * 100 & "% </td></tr> "
        AR2_Debug.Text += "<tr align=left><td> Credits Value</td><td>" & (standardPremium * CreditsPercentage) & " </td></tr> "
        standardTotal = (standardPremium - (standardPremium * CreditsPercentage))
        'NO Credits for Rental Package

        '**********************************************
        AR1_Debug.Text += "<tr align=left><td>SUB TOTAL </td><td>" & packageTotal & " </td></tr> "
        AR2_Debug.Text += "<tr align=left><td>SUB TOTAL </td><td>" & standardTotal & " </td></tr> "
        AR3_Debug.Text += "<tr align=left><td>SUB TOTAL </td><td>" & rentalTotal & " </td></tr> "
        ...
        If MHage >= 21 Then
            'Package
            packageTotal += (CDbl(packagePremium) * 0.065)
            AR1_Debug.Text += "<tr align=left><td>MH AGE 21 YRS OLDER  </td><td>" & (CDbl(packagePremium) * 0.065) & " </td></tr> "
        ...
        AR1_Debug.Text += "<tr align=left><td>SUB TOTAL 1 </td><td> " & packageTotal & " </td></tr>"

        AR2_Debug.Text += "<tr align=left><td>SUB TOTAL 1 </td><td> " & standardTotal & " </td></tr>"

        AR3_Debug.Text += "<tr align=left><td>SUB TOTAL 1 </td><td> " & rentalTotal & " </td></tr>"


        'Set Values for ded Calc
        ar_baseprem1.Text = packageTotal
        ar_baseprem2.Text = standardTotal
        ar_baseprem3.Text = rentalTotal
        'Set deduction Options
        ARDedOptions()
        'Return Values
        packageTotal = ar_baseprem1.Text
        standardTotal = ar_baseprem2.Text
        rentalTotal = ar_baseprem3.Text



        AR1_Debug.Text += "<tr align=left><td>SUB TOTAL 2</td><td>" & packageTotal & " </td></tr> "
        AR2_Debug.Text += "<tr align=left><td>SUB TOTAL 2</td><td>" & standardTotal & " </td></tr> "
        AR3_Debug.Text += "<tr align=left><td>SUB TOTAL 2</td><td>" & rentalTotal & " </td></tr> "
        ...
        packageFee += (CDbl(ar_baseprem1.Text) * 0.01)
        CEA_ar1_Amount.Text = (CDbl(ar_baseprem1.Text) * 0.01)
        standardFee += (CDbl(ar_baseprem2.Text) * 0.01)
        CEA_ar2_Amount.Text = (CDbl(ar_baseprem2.Text) * 0.01)
        rentalFee += (CDbl(ar_baseprem3.Text) * 0.01)
        CEA_ar3_Amount.Text = (CDbl(ar_baseprem3.Text) * 0.01)
        AR1_Debug.Text += "<tr align=left><td>Citizens Emergency Assessment FEE  </td><td> " & (CDbl(ar_baseprem1.Text)) * 0.01 & " </td></tr>  " '+ CDbl(ar_options1.Text)
        AR2_Debug.Text += "<tr align=left><td>Citizens Emergency Assessment FEE  </td><td> " & (CDbl(ar_baseprem2.Text)) * 0.01 & " </td></tr>  "
        AR3_Debug.Text += "<tr align=left><td>Citizens Emergency Assessment FEE  </td><td> " & (CDbl(ar_baseprem3.Text)) * 0.01 & " </td></tr>  "
        'Florida Hurr CAT Fund (1.3%)   
        packageFee += (CDbl(ar_baseprem1.Text) * 0.013)
        standardFee += (CDbl(ar_baseprem2.Text) * 0.013)
        rentalFee += (CDbl(ar_baseprem3.Text) * 0.013)
        AR1_Debug.Text += "<tr align=left><td>Florida Hurr CAT Fund FEE  </td><td> " & CDbl(ar_baseprem1.Text) * 0.013 & " </td></tr> " '+ CDbl(ar_options1.Text)
        AR2_Debug.Text += "<tr align=left><td>Florida Hurr CAT Fund FEE  </td><td> " & CDbl(ar_baseprem2.Text) * 0.013 & " </td></tr> " '+ CDbl(ar_options2.Text)
        AR3_Debug.Text += "<tr align=left><td>Florida Hurr CAT Fund FEE  </td><td> " & CDbl(ar_baseprem3.Text) * 0.013 & " </td></tr> " '+ CDbl(ar_options2.Text)


        'Set Fee Values
        ar_fees1.Text = String.Format("{0:C0}", Math.Round(CDbl(packageFee)))
        ar_fees2.Text = String.Format("{0:C0}", Math.Round(CDbl(standardFee)))
        ar_fees3.Text = String.Format("{0:C0}", Math.Round(CDbl(rentalFee)))
        '**********************************************
        ...
        ar_total1.Text = String.Format("{0:C0}", Math.Round(CDbl(ar_baseprem1.Text) + CDbl(ar_options1.Text) + CDbl(ar_fees1.Text) + CDbl(ar_tax1.Text) + CDbl(packmed.ToString())))
        ar_total2.Text = String.Format("{0:C0}", Math.Round(CDbl(ar_baseprem2.Text) + CDbl(ar_options2.Text) + CDbl(ar_fees2.Text) + CDbl(ar_tax2.Text) + CDbl(standmed)))
        ar_total3.Text = String.Format("{0:C0}", Math.Round(CDbl(ar_baseprem3.Text) + CDbl(ar_options3.Text) + CDbl(ar_fees3.Text) + CDbl(ar_tax3.Text) + CDbl(rentmed)))
    End Sub
    Protected Sub ARDedOptions()
        Dim ds As System.Data.DataSet
        ...
        'Calc & apply Package
        packageNonHur = (packageBase * packageNonHur)

        AR1_Debug.Text += "<tr align=left><td>Non Hurricane </td><td> -" & packageNonHur & " </td></tr> "
        packageHur = (packageBase * packageHur)
        AR1_Debug.Text += "<tr align=left><td>Hurricane </td><td> - " & packageHur & " </td></tr> "
        txt_DedChange_AR1_Amount.Text = packageHur + packageNonHur
        packageBase = (packageBase - packageNonHur)
        packageBase = (packageBase - packageHur)
        ...
        'Calc & apply Standard
        Dim temp As Double
        standardNonHur = (standardBase * standardNonHur)

        AR2_Debug.Text += "<tr align=left><td>Non Hurricane </td><td> -" & standardNonHur & " </td></tr> "
        standardHur = (standardBase * standardHur)
        temp = standardNonHur + standardHur
        SeasonalFee_ar2_Amount.Text = temp
        AR2_Debug.Text += "<tr align=left><td>Hurricane </td><td> - " & standardHur & " </td></tr> "
        txt_DedChange_AR2_Amount.Text = standardNonHur + standardHur
        standardBase = (standardBase - standardNonHur)
        standardBase = (standardBase - standardHur)

        StandNonHur = standardNonHur
        StandHur = standardHur

        'Calc & apply Rental
        rentalNonHur = (rentalBase * rentalNonHur)
        AR3_Debug.Text += "<tr align=left><td>Non Hurricane </td><td> -" & rentalNonHur & " </td></tr> "
        rentalHur = (rentalBase * rentalHur)
        AR3_Debug.Text += "<tr align=left><td>Hurricane </td><td> - " & rentalHur & " </td></tr> "
        txt_DedChange_AR3_Amount.Text = rentalNonHur + rentalHur
        rentalBase = (rentalBase - rentalNonHur)
        rentalBase = (rentalBase - rentalHur)
    ...
    Public Sub AROptions()
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            dd_pl_AR1_Amount.Text = FormatCurrency(perLiab_ar1).ToString

            SecureInterest_ar1 = ds.Tables(0).Rows(0).Item("PackageSecInt").ToString
            SecureInterest_ar1_Amount.Text = FormatCurrency(SecureInterest_ar1).ToString()

            NaturalDisaster_ar1 = ds.Tables(0).Rows(0).Item("PackageND").ToString
            dd_ndp_AR1_Amount.Text = FormatCurrency(NaturalDisaster_ar1).ToString()

            MHReplCost_ar1 = ds.Tables(0).Rows(0).Item("PackageMHRep").ToString
            dd_mhr_AR1_Amount.Text = FormatCurrency(MHReplCost_ar1).ToString()

            PersonalEffRepCost_ar1 = ds.Tables(0).Rows(0).Item("PackagePerEffCost").ToString
            dd_rep_AR1_Amount.Text = FormatCurrency(CDbl(PersonalEffRepCost_ar1) * (CDbl(txt_pp_AR1.Text) / 100)).ToString()

            AddlRadio_ar1 = ds.Tables(0).Rows(0).Item("PackageAddlRadio").ToString
            txt_addlimrad_AR1_Amount.Text = FormatCurrency(AddlRadio_ar1).ToString()

            AddlFire_ar1 = ds.Tables(0).Rows(0).Item("PackageAddlFire").ToString
            txt_addlimfir_AR1_Amount.Text = FormatCurrency(AddlFire_ar1).ToString()

            ar1_addResidents = ds.Tables(0).Rows(0).Item("PackageAddResidence").ToString
            dd_addresOpt_ar1_Amount.Text = FormatCurrency(ar1_addResidents).ToString()

            ar1_waterCraftType = ds.Tables(0).Rows(0).Item("PackageWaterCraft").ToString
            dd_waterCraft_AR1_Amount.Text = FormatCurrency(ar1_waterCraftType).ToString()
            ...
            supHeating_ar1_Amount.Text = FormatCurrency(supHeat).ToString()
        Else
            'no rates found
            perLiab_ar1 = "0.00"
        ...
        ar_options1.Text = FormatCurrency(ar1_fee)
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            dd_pl_AR2_Amount.Text = FormatCurrency(perLiab_ar2).ToString

            SecureInterest_ar2 = ds.Tables(0).Rows(0).Item("StandardSecInt").ToString
            SecureInterest_ar2_Amount.Text = FormatCurrency(SecureInterest_ar2).ToString()

            NaturalDisaster_ar2 = ds.Tables(0).Rows(0).Item("StandardND").ToString
            dd_ndp_AR2_Amount.Text = FormatCurrency(NaturalDisaster_ar2).ToString()

            MHReplCost_ar2 = ds.Tables(0).Rows(0).Item("StandardMHRep").ToString
            dd_mhr_AR2_Amount.Text = FormatCurrency(MHReplCost_ar2).ToString()

            PersonalEffRepCost_ar2 = ds.Tables(0).Rows(0).Item("StandardPerEffCost").ToString
            dd_rep_AR2_Amount.Text = FormatCurrency(PersonalEffRepCost_ar2).ToString()

            AddlRadio_ar2 = ds.Tables(0).Rows(0).Item("StandardAddlRadio").ToString
            txt_addlimrad_AR2_Amount.Text = FormatCurrency(AddlRadio_ar2).ToString()

            AddlFire_ar2 = ds.Tables(0).Rows(0).Item("StandardAddlFire").ToString
            txt_addlimfir_AR2_Amount.Text = FormatCurrency(AddlFire_ar2).ToString()

            ar2_addResidents = ds.Tables(0).Rows(0).Item("StandardAddResidence").ToString
            dd_addresOpt_ar2_Amount.Text = FormatCurrency(ar2_addResidents).ToString()

            ar2_waterCraftType = ds.Tables(0).Rows(0).Item("StandardWaterCraft").ToString
            dd_waterCraft_ar2_Amount.Text = FormatCurrency(ar2_waterCraftType).ToString()
            ...
            supHeating_ar2_Amount.Text = FormatCurrency(supHeat).ToString()
        Else
            'no rates found
            perLiab_ar2 = "0.00"
        ...
        ar2_fee += CDbl(PersonalEffRepCost_ar2) * (CDbl(txt_pp_AR2.Text) / 200) 'Contents
        ...
        ar_options2.Text = String.Format("{0:C0}", Math.Round(CDbl(ar2_fee)))
        ...
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            dd_pl_AR3_Amount.Text = FormatCurrency(perLiab_ar3).ToString

            SecureInterest_ar3 = ds.Tables(0).Rows(0).Item("RentalSecInt").ToString
            dd_sip_AR3_Amount.Text = FormatCurrency(SecureInterest_ar3).ToString()

            NaturalDisaster_ar3 = ds.Tables(0).Rows(0).Item("RentalND").ToString
            dd_ndp_AR3_Amount.Text = FormatCurrency(NaturalDisaster_ar3).ToString()

            perLiab_ar3 = ds.Tables(0).Rows(0).Item("RentalLiab").ToString
            dd_pl_AR3_Amount.Text = FormatCurrency(perLiab_ar3).ToString()

            AddlRadio_ar3 = ds.Tables(0).Rows(0).Item("RentalAddlRadio").ToString
            txt_addlimrad_AR3_Amount.Text = FormatCurrency(AddlRadio_ar3).ToString()

            AddlFire_ar3 = ds.Tables(0).Rows(0).Item("RentalAddlFire").ToString
            txt_addlimfir_AR3_Amount.Text = FormatCurrency(AddlFire_ar3).ToString()

            supHeat = ds.Tables(0).Rows(0).Item("rentalsupHeat").ToString
            supHeating_ar3_Amount.Text = FormatCurrency(supHeat).ToString()
        Else
            'no rates found
            perLiab_ar3 = "0.00"
        ...
        ar_options3.Text = String.Format("{0:C0}", Math.Round(CDbl(ar3_fee)))
    ...
    Protected Function getCredits()
        ...
        End If
        'Insured age
        If IsNumeric(txtDOB.Text.Substring(txtDOB.Text.Length - 4, 4)) Then
    ...
    Public Sub TransferToLloydsApp()
        'Savecalc
        Response.Redirect("../Application/LloydsApplication.aspx")
    End Sub
    'End Lloyds
    '**************************************************
    ...
    Public Sub CalcValuation_Click() Handles calcValue.Click
        ...
        Try
            ...
            homeAge = curDate.Year - CInt(year)
            If homeAge <= 0 Then
                homeAge = 1
            End If
    ...
    Public Sub SelectSub()
        If ddlSub_main.SelectedValue <> "0" And ddlSub_main.SelectedValue <> "New" Then
            Dim cn As New SqlClient.SqlConnection(System.Configuration.ConfigurationManager.ConnectionStrings("ColonialWebConnectionString").ConnectionString)
            Try
                Dim cmd As New SqlClient.SqlCommand
                cmd.Connection = cn
                cmd.CommandText = "SELECT * FROM vwAgents WHERE ID = " & ddlSub_main.SelectedValue
                If cmd.Connection.State = ConnectionState.Closed Then cmd.Connection.Open()
    ...
    Private Sub LoadCalcintoDB(ByVal quoteID As String)
        ...
        tsql += "'" & PackPrem.Replace("$", "") & "',"
        tsql += "'" & StandPrem.Replace("$", "") & "',"
        tsql += "'" & RentPrem.Replace("$", "") & "',"
        tsql += "'" & CreditPerc.Replace("$", "") & "',"
        tsql += "'" & Packsub1.Replace("$", "") & "',"
        tsql += "'" & Standsub1.Replace("$", "") & "',"
        tsql += "'" & Rentsub1.Replace("$", "") & "',"
        tsql += "'" & PackNonHur.Replace("$", "") & "',"
        tsql += "'" & PackHur.Replace("$", "") & "',"
        tsql += "'" & StandNonHur.Replace("$", "") & "',"
        tsql += "'" & StandHur.Replace("$", "") & "',"
        tsql += "'" & RentNonHur.Replace("$", "") & "',"
        tsql += "'" & RentHur.Replace("$", "") & "',"
        tsql += "'" & PackOption.Replace("$", "") & "',"
        tsql += "'" & StandOpt.Replace("$", "") & "',"
        tsql += "'" & RentOpt.Replace("$", "") & "'"
