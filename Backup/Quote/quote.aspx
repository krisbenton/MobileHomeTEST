...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <script type="text/javascript">
        ...
        function ARShowPackageMedPay() {
            ...
            var currentSelection = e.options[e.selectedIndex].text;
            if (currentSelection == "") {
                document.getElementById('AR_AddResOpt1_ar1').style.display = 'none';
                document.getElementById('AR_AddResOpt2_ar1').style.display = 'none';
            }
            else {
                document.getElementById('AR_AddResOpt1_ar1').style.display = '';
                document.getElementById('AR_AddResOpt2_ar1').style.display = '';
            }
            AR_UpdateOptions();
        ...
        function ARShowPackageMedPay2() {
            ...
            var currentSelection = e.options[e.selectedIndex].text;
            if (currentSelection == "") {
                document.getElementById('AR_AddResOpt1_ar2').style.display = 'none';
                document.getElementById('AR_AddResOpt2_ar2').style.display = 'none';
            }
            else {
                document.getElementById('AR_AddResOpt1_ar2').style.display = '';
                document.getElementById('AR_AddResOpt2_ar2').style.display = '';
            }
            AR_UpdateOptions();
        } // end ARShowPackageMedPay
        ...
        function ARCalcTotals() {
            ...
            Total += parseFloat(ar_options1) + parseFloat(ar_fees1) + parseFloat(ar_tax1);
            document.getElementById('<%=ar_total1.ClientID%>').innerHTML = '$' + Total.toFixed(0);
            //alert('ar1 ' + Total);
            Total = 0;
            //Standard Total
            ...
            document.getElementById('<%=ar_total2.ClientID%>').innerHTML = '$' + Total.toFixed(0);
            //alert('ar2 ' + Total);
            Total = 0;
            //Rental Total
            ...
            Total += parseFloat(ar_options3) + parseFloat(ar_fees3) + parseFloat(ar_tax3);
            document.getElementById('<%=ar_total3.ClientID%>').innerHTML = '$' + Total.toFixed(0);
        ...
        function ARIsLienHolder() {
            ...
            if (currentSelection == "Yes") {
                ...
                document.getElementById('trmhAROpt1').style.display = '';
                document.getElementById('trmhAROpt1_d').style.display = '';
                document.getElementById('trmhAROpt1_2').style.display = '';
                document.getElementById('trmhAROpt1_2_d').style.display = '';
                //second option section
                document.getElementById('trmhAROpt2').style.display = '';
                document.getElementById('trmhAROpt2_2').style.display = '';
                document.getElementById('trmhAROpt2_d').style.display = '';
                document.getElementById('trmhAROpt2_2_d').style.display = '';
                ...
                //Hide
                //first option section
                document.getElementById('trmhAROpt1').style.display = 'none';
                document.getElementById('trmhAROpt1_d').style.display = 'none';
                document.getElementById('trmhAROpt1_2').style.display = 'none';
                document.getElementById('trmhAROpt1_2_d').style.display = 'none';
                //second option section
                document.getElementById('trmhAROpt2').style.display = 'none';
                document.getElementById('trmhAROpt2_2').style.display = 'none';
                document.getElementById('trmhAROpt2_d').style.display = 'none';
                document.getElementById('trmhAROpt2_2_d').style.display = 'none';
                //third option section
                        ...
                        <table>
                            <tbody>
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtSubNumber" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtAgConName" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtConEmail" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtAppFirstName" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtAppLastName" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtAppEmail" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtAppAddr" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                ...
                                                <table width="105%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtCounty" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                ...
                                                <table width="100%">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtLength" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtWidth" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr id="trmhqstn5" style="display: none">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="supHeatTypedd" runat="server" TabIndex="24">
                                            <asp:ListItem> </asp:ListItem>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="border: 1px solid black"
                                ...
                                <tbody>
                                    <tr style="border: 1px solid black">
                                        ...
                                        <td align="center" style="border: 1px solid black">
                                            <asp:Label ID="Label49" runat="server" Text="Additional Adjacent Structures - " CssClass="label" />
                                        </td>
                                        <td align="center" style="border: 1px solid black">
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                             ...
                                             <asp:Label ID="rateTypelbl" runat="server" Text="" CssClass="label"></asp:Label>
                                                ...
                                                <td>
                                                    <asp:Button ID="premFinbtn" runat="server" OnClick="printbtn_Click" Text="Print Finance Contract" />
                                                </td>
                                                <td>
                                                    <asp:HiddenField ID="HiddenFieldSelected" runat="server" Value="" ClientIDMode="Static"/>
                                                    <input id="ar_mh_progbtn1" type="button" value="Proceed to App" onclick="openAROptions();" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                                ...
                                                <td colspan="18">
                                                    <table id="AROptionRow1" runat="server" width="auto" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left">
                                                                    <input id="btnShow" type="button" value="Open Calc Detail" onclick="openCalcDesc(1);" />
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label108" runat="server" Text="Personal Liability:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label148" runat="server" Text="Medical payment:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label65" runat="server" Text="Increase Other Structures:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr style="border: 1px solid;">
                                                                <td align="left">
                                                                    <asp:Label ID="Label104" runat="server" Text="Increase Contents:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label98" runat="server" Text="Mobile Home Replacement Cost:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label100" runat="server" Text="Contents Replacement Cost:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td id="trmhAROpt1_2" style="display: none" align="left" clientidmode="Static">
                                                                    <asp:Label ID="Label92" runat="server" Text="Secured Interest  Protection:  " CssClass="label" />&nbsp
                                                                </td>
                                                            ...
                                                            <tr style="border: 1px solid black">
                                                                <td align="left">
                                                                    <asp:Label ID="Label99" runat="server" Text="Additional Residence:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_AddResOpt1_ar1" style="display: none" clientidmode="Static">
                                                                <td align="left">
                                                                    ...
                                                                    <asp:Label ID="Label95" runat="server" Text="Additional Residence Liability" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr style="border: 1px solid;">
                                                                <td align="left">
                                                                    <asp:Label ID="Label151" runat="server" Text="Watercraft" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_WaterCraftOpt1_ar1" style="display: none">
                                                                <td align="left">
                                                                    ...
                                                                    <asp:Label ID="Label152" runat="server" Text="Watercraft Liability" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_WaterCraftOpt2_ar1" style="display: none">
                                                                <td align="left">
                                                                    <asp:Label ID="Label153" runat="server" Text="Watercraft Medical payment:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label154" runat="server" Text="Valuable Personal Property:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label143" runat="server" Text="Secured Interest Protection:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                                    &nbsp;
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label142" runat="server" Text="Supplemental Heating:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                                    &nbsp;
                                                ...
                                                <td colspan="18">
                                                    <table id="AROptionRow2" runat="server" width="auto" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label105" runat="server" Text="Personal Liability:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_StandardMedPay" style="display: none" clientidmode="Static">
                                                                <td align="left">
                                                                    <asp:Label ID="Label149" runat="server" Text="Medical payment:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label115" runat="server" Text="Other Structures:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label116" runat="server" Text="Contents:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label117" runat="server" Text="Mobile Home Replacement Cost:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label118" runat="server" Text="Contents Replacement Cost:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td id="trmhAROpt2_2" style="display: none" align="left" clientidmode="Static">
                                                                    <asp:Label ID="Label135" runat="server" Text="Secured Interest  Protection:  " CssClass="label" />&nbsp
                                                                </td>
                                                            ...
                                                            <tr style="border: 1px solid black">
                                                                <td align="left">
                                                                    <asp:Label ID="Label155" runat="server" Text="Additional Residence:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_AddResOpt1_ar2" style="display: none" clientidmode="Static">
                                                                <td align="left">
                                                                    <asp:Label ID="Label156" runat="server" Text="Additional Residence Liability" CssClass="label" />&nbsp
                                                            ...
                                                            <tr style="border: 1px solid;">
                                                                <td align="left">
                                                                    <asp:Label ID="Label158" runat="server" Text="Watercraft" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_WaterCraftOpt1_ar2" style="display: none" clientidmode="Static">
                                                                <td align="left">
                                                                    <asp:Label ID="Label159" runat="server" Text="Watercraft Liability" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr id="AR_WaterCraftOpt2_ar2" style="display: none">
                                                                <td align="left">
                                                                    <asp:Label ID="Label160" runat="server" Text="Watercraft Medical payment:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label161" runat="server" Text="Valuable Personal Property:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label162" runat="server" Text="Secured Interest Protection:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                                    &nbsp;
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label164" runat="server" Text="Supplemental Heating:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                                    &nbsp;
                                                ...
                                                <td colspan="18">
                                                    <table id="AROptionRow3" runat="server" width="auto" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <td>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label150" runat="server" Text="Medical payment:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label140" runat="server" Text="Other Structures:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label141" runat="server" Text="Contents:  " CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                            ...
                                                            <tr>
                                                                <td id="trmhAROpt3_2" style="display: none" align="left">
                                                                    <asp:Label ID="Label146" runat="server" Text="Secured Interest  Protection:  " CssClass="label" />&nbsp
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <asp:Label ID="Label163" runat="server" Text="Supplemental Heating:" CssClass="label" />&nbsp
                                                                </td>
                                                                <td align="left">
                                                                    &nbsp;
