Public Class findImportQuote
    ...
    Public Sub loadDefault()
        ...
        tsql = "SELECT quoteID, applicantFirstName + ' ' + applicantLastName AS applicantName, CONVERT(VARCHAR,effDate,101) AS effDate FROM tblQuotes WHERE ARImportID !='' ORDER BY quoteID DESC"
