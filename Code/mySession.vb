...
Public Class mySession
   ...
   Shared Property UploadFileName() As String
      ...
      End Set
    End Property
    Shared Property UWUser() As Common.UserData
        Get
            Dim value As Common.UserData = CType(HttpContext.Current.Session("UWUser"), Common.UserData)
            Return value
        End Get
        Set(ByVal value As Common.UserData)
            HttpContext.Current.Session("UWUser") = value
        End Set

    End Property
    Shared Property AdminUser() As Common.UserData
        Get
            Dim value As Common.UserData = CType(HttpContext.Current.Session("AdminUser"), Common.UserData)
            Return value
        End Get
        Set(ByVal value As Common.UserData)
