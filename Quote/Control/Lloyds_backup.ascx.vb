...
Public Class Lloyds
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Public Sub loadpremdata(ByVal value As String, ByVal state As String, ByVal type As String, ByVal mfg As String, ByVal year As String, ByVal county As String, ByVal Quoteid As String, ByVal Usage As String, ByVal dist As String, ByVal prot As String, ByVal lien As String, ByVal subheat As String, ByVal dob As String, ByVal skirt As String)
    ...
    Public Sub Calc()
        ...
        lblchange.Text = ""
        If IsNumeric(txt_unattstr_AR1.Text) Then
            If CInt(txt_unattstr_AR1.Text) < 500 Then
            ...
            End If
        End If
        If IsNumeric(txt_pp_AR1.Text) Then
            If CInt(txt_pp_AR1.Text) < CInt(mhvalue * 0.3) Then
                txt_pp_AR1.Text = CInt(mhvalue * 0.3)
    ...
    Public Sub calcAegis()
        ...
        If CInt(mhvalue) < 125001 Then
                    ...
                    Select Case display
                        ...
                        Case "Rental"
                            ...
                            Else
                                ...
                                aiges_mh_prog3_Options.Visible = True
                                If lblaiges_ShowOptions3_hidden.Value = "- Show Options" Then
                                    aiges_mh_prog3_Options.Style.Add("display", "block")
                                    Table2.Style.Add("display", "block")
                                    lblaiges_ShowOptions3.InnerText = "- Show Options"
            ...
            Catch ex As Exception
                errortrap("Geting Calculation data", "Calculation Aegis", ex.Message)
            End Try
        End If
    End Sub
        ...
        If IsNumeric(txtvaluePPL.Text) Then
            ...
            Else
                ...
                Else
                    ...
                    Catch ex As Exception
                        errortrap("Adding PPL for Aegis data", "Calculation AddPPL", ex.Message)
                    End Try
    ...
    Public Sub loadAegisPP()
        ...
        Catch ex As Exception
            errortrap("Geting Aegis PP data", "Grid", ex.Message)
        End Try
    ...
    Public Sub AegisPPtotals()
        ...
        Catch ex As Exception
            errortrap("Geting Aegis data", "Totals", ex.Message)
        End Try
    ...
    Public Sub SaveAegis(ByVal quoteID As String)
        If quoteID <> "" Then
            ...
            cmd.Parameters.Add("@RentFees", SqlDbType.VarChar, 8000).Value = "45"
            ...
            Try
                ...
                myCommand.Fill(ds, "tbl1")
            Catch ex As Exception
                errortrap("Saving Aegis Data", "Save Prem", ex.Message)
            End Try
        End If
    ...
    Private Sub btnpp_Click(sender As Object, e As System.EventArgs) Handles btnpp.Click
        If dd_PackagePerProp_aiges.SelectedValue = "No" Then
            ...
            Try
                ...
                myCommand.Fill(ds, "tbl1")
            Catch ex As Exception
                errortrap("Deleteing Aegis Data", "Delete PP data all", ex.Message)
            End Try
