<%@ Page Language="vb" Title="TCG Mobile Home Rater" AutoEventWireup="false" CodeBehind="quote.aspx.vb" Inherits="MobileHomeRater.quote" MasterPageFile="../IntPage.Master" EnableEventValidation="false"  EnableSessionState="true" EnableViewState="true" %>
<%@ Register assembly="DevExpress.Web.v13.1, Version=13.1.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxGridView" tagprefix="dx" %>
<%@ Register assembly="DevExpress.Web.v13.1, Version=13.1.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" namespace="DevExpress.Web.ASPxEditors" tagprefix="dx" %>
<%@ Register src="Control/Lloyds.ascx" tagname="Lloyds" tagprefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMenu" runat="server">
    <script type="text/javascript">
        ...
        function ShowGeneralFinancingQuote() {
            
            PremiumFinanceLenQuote.SetVisible(false);
            
            if (document.getElementById('<%=lblState.ClientID%>').innerText == 'NC') {
                PremiumFinanceLenQuote.SetVisible(true);
            }
            if (document.getElementById('<%=lblState.ClientID%>').innerText == 'SC') {
                PremiumFinanceLenQuote.SetVisible(true);
            }
            if (document.getElementById('<%=lblState.ClientID%>').innerText == 'VA') {
                PremiumFinanceLenQuote.SetVisible(true);
            }
             
            PremiumFinancingPopupQuote.Show();
...
//                document.getElementById('<%=btnloss.ClientID%>').click();
            }
        ...
        function UpdateDOB() {
            ...
            var currentText;
            currentText = document.getElementById('<%=txtDOB1.ClientID%>').value;

            if (currentText.length == 7) {

                document.getElementById('<%=txtDOB1.ClientID%>').value = currentText.substring(0, 2) + '/' + currentText.substring(2, 4) + '/' + currentText.substring(4, 8);
        ...
        function MHValidate() {
            ...
            if (HomeAge > 10) {
                document.getElementById('<%=ddansi.ClientID%>').selectedIndex = 3;
            }
            if (HomeAge < 10) {
                document.getElementById('<%=ddansi.ClientID%>').selectedIndex = 2;
            }
        } //end MHValidate
        //Check Owner Type
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
                        ...
                        <table>
                            <tbody>
                                <tr align="left">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="termdd" runat="server" alt="Term" TabIndex="1">
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox style="text-transform:uppercase" ID="txtSubNumber" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    ...
                                                                    ClientIDMode="Static" />
                                                                <br />
                                                                <asp:DropDownList ID="ddlSub_main2" runat="server" AutoPostBack="false" Visible="false"
                                                                    ClientIDMode="Static" TabIndex="2">
                                                                </asp:DropDownList>
                                                                	<dx:ASPxComboBox ID="ddlSub_main" ClientInstanceName="ddlSub_main" Visible="false" runat="server" Width="200"  DropDownStyle="DropDown" TabIndex="2" AutoPostBack="true">
                                                                   <ValidationSettings SetFocusOnError="true" ValidateOnLeave="true">
                                                                   <RequiredField ErrorText="Must Choose Agent" IsRequired="true" />
                                                                   </ValidationSettings>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox style="text-transform:uppercase" ID="txtAgConName" runat="server" 
                                                                    AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    ToolTip="Sub Number" Width="180px" TabIndex="3" Enabled="false" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox style="text-transform:uppercase" ID="txtConEmail" runat="server" 
                                                                    AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    ToolTip="Sub Number" Width="180px" TabIndex="4" Enabled="false" />
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtEffDate" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                            ToolTip="Effective Date" Width="100px" TabIndex="5" />
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox style="text-transform:uppercase" ID="txtAppFirstName" 
                                            runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                            ToolTip="First Name" Width="200px" TabIndex="6" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox style="text-transform:uppercase" ID="txtAppLastName" 
                                            runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                            ToolTip="Last Name" Width="200px" TabIndex="7" />
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox style="text-transform:uppercase" ID="txtAppEmail" runat="server" 
                                            AutoCompleteType="DisplayName" Casing="UPPER"
                                            ToolTip="Email" Width="200px" TabIndex="8" />
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                     <dx:ASPxTextBox ID="txtDOB1" runat="server" Width="130" TabIndex="9" >
                                    ...
                                    <ValidationSettings SetFocusOnError="false" >
                                     ...
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtDOB1"
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox style="text-transform:uppercase" ID="txtAppAddr" runat="server" 
                                            AutoCompleteType="DisplayName" Casing="UPPER"
                                            ToolTip="Address" Width="200px" TabIndex="10" />
                                                ...
                                                <table width="105%">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtZip" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    ToolTip="Zip Code" Width="55px" AutoPostBack="true" TabIndex="11" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:DropDownList ID="cddlCity" runat="server" TabIndex="12">
                                                                </asp:DropDownList>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                ...
                                                                <dx:ASPxPopupControl ID="ASPxPopupControl5" runat="server" PopupElementID="txtCounty" ShowHeader="false" CloseAction="None" ShowCloseButton="false"
                                                                                ...
                                                                                <table border="0" cellpadding="4" cellspacing="0">
                                                                                    <tr>
                                                                                        <td valign="top" colspan="2">
                                                                                            ...
                                                                                            <asp:Label ID="WinHailLBL" runat="server" ClientIDMode="Static" Text="Is the risk eligible for coverage in the South Carolina Windstorm & Hail Association?"></asp:Label>
                                                                                        </td>
                                                                                    </tr>
                                                                                  <tr>
                                                                                  <td>
                                                                                      <asp:Button ID="SCWHYes" runat="server" Text="Yes" /></td>
                                                                                  <td>
                                                                                      <asp:Button ID="SCWNo" runat="server" Text="No" /></td>
                                                                                  </tr>
                                                                                </table>
                                                                            </asp:Panel>
                        ...
                        <table>
                            <tbody>
                                                ...
                                                <table width="105%">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:DropDownList ID="distToCoastDD" runat="server" TabIndex="13" 
                                                                    ClientIDMode="Static">
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="homeusedd" runat="server" TabIndex="14">
                                            <asp:ListItem></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="typedd" runat="server" TabIndex="15">
                                            <asp:ListItem></asp:ListItem>
                                                ...
                                                <table width="100%">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox ID="txtYear" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    CausesValidation="false" ToolTip="year" Width="45" TabIndex="16" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox style="text-transform:uppercase" ID="txtLength" runat="server" 
                                                                    AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    CausesValidation="false" ToolTip="length" Width="45" TabIndex="17" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:TextBox style="text-transform:uppercase" ID="txtWidth" runat="server" 
                                                                    AutoCompleteType="DisplayName" Casing="UPPER"
                                                                    CausesValidation="false" ToolTip="width" Width="45" TabIndex="18" />
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td align="left">
                                                                <asp:DropDownList ID="manfdd" runat="server" TabIndex="19" 
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <asp:Label ID="Label29" runat="server" Text="Estimated Appraisal" CssClass="label" CausesValidation="false" />
                                                            </td>
                                                            <td align="left">
                                                                <asp:TextBox ID="txtValuation" runat="server" AutoCompleteType="DisplayName"
                                                                    Casing="UPPER" ReadOnly="true" ToolTip="Valuation" Width="65" 
                                                                    TabIndex="20" />
                                                            </td>
                                                        </tr>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtcvgamt" runat="server" AutoCompleteType="DisplayName" Casing="UPPER"
                                            ToolTip="Coverage Amount" Width="65" TabIndex="21" />
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="protclassdd" runat="server" TabIndex="22">
                                            <asp:ListItem></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="skirtdd" runat="server" TabIndex="23">
                                            <asp:ListItem></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="liendd" runat="server" TabIndex="24">
                                            <asp:ListItem></asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="lapsdd" runat="server" TabIndex="25">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="supheatdd" runat="server" TabIndex="26">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr id="trmhqstn5" style="display: none">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="supHeatTypedd" runat="server" TabIndex="27">
                                            <asp:ListItem> </asp:ListItem>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="priorlosdd" runat="server" TabIndex="28">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="mhparkdd" runat="server" TabIndex="29">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <table width="100%">
                                                    <tr align="left">
                                                        <td align="left">
                                                            <asp:DropDownList ID="ddansi" runat="server" TabIndex="30">
                                                                <asp:ListItem></asp:ListItem>
                                                                <asp:ListItem>Yes</asp:ListItem>
                                                                <asp:ListItem>No</asp:ListItem>
                                                            </asp:DropDownList>
                                ...
                                <tr id="trmhqstn1" style="display: none">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="mhResMangdd" runat="server" TabIndex="31">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr id="trmhqstn2" style="display: none">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="mhSpacdd" runat="server" TabIndex="32">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr id="trmhqstn3" style="display: none">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="mhlightdd" runat="server" TabIndex="33">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr id="trmhqstn4" style="display: none">
                                    ...
                                    <td align="left">
                                        <asp:DropDownList ID="mhInsAge" runat="server" TabIndex="34">
                                            <asp:ListItem></asp:ListItem>
                                            <asp:ListItem>Yes</asp:ListItem>
                                            <asp:ListItem>No</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <tr>
                                    <td id="popupanchor" align="left">
                                        <asp:Button ID="prmbtn" runat="server" Text="Calculate Premium" TabIndex="35" 
                                            OnClick="calc_Clicked" />
        ...
        <ajaxTK:ModalPopupExtender ID="ModalPopupExtender3" runat="server" BehaviorID="FinanceModal"
        ...
        <table id="NewLloyd" runat="server" width="100%">
            <tbody>
            <tr>
                <td>
                    <uc1:Lloyds ID="Lloyds1" runat="server" />
                    <br />
                </td>
                <td>
                    <br />
                                ...
                                <ContentTemplate>
                                    <table id="premiumBtnTable" runat="server" style="display: none;" align="center">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label75" runat="server" Text="Selected Program: " CssClass="label"></asp:Label>
                                                    &nbsp;
                                                ...
                                                <td>
                                                <dx:ASPxButton runat="server" ID="premCalcbtnQuote" Text="Calculate Financing">
                                                <ClientSideEvents Click="function(s,e){ShowGeneralFinancingQuote();}" />
                                                </dx:ASPxButton>
                                                 <!--General Finance Popup-->
                                                    <dx:ASPxPopupControl ID="PremiumFinancingPopupQuote" ClientInstanceName="PremiumFinancingPopupQuote"
                                                                PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" MaxWidth="800px"
                                                                MaxHeight="1800px" MinHeight="150px" MinWidth="150px" ShowFooter="false" Width="550px"
                                                                Height="330px" runat="server" Modal="true" HeaderText="Premium Finance Quote">
                                                                <ContentCollection>
                                                                    <dx:PopupControlContentControl ID="PremiumFinancingPopupContentControlQuote" runat="server">
                                                                        <div>
                                                                            <table>
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td>
                                                                                            <table>
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="Label170" runat="server" Text="Financing Company: " Font-Bold="True"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="lblGeneralFinanceTypeQuote" runat="server" Text="" Font-Bold="false"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="Label174" runat="server" Text="Payment Plan:" Font-Bold="True"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <dx:ASPxRadioButtonList ID="PremiumFinanceDPQuote" runat="Server" ClientInstanceName="PremiumFinanceDP">
                                                                                                                <Items>
                                                                                                                    <dx:ListEditItem Value="25% Down" />
                                                                                                                    <dx:ListEditItem Value="40% Down" />
                                                                                                                    <dx:ListEditItem Value="50% Down" />
                                                                                                                </Items>
                                                                                                                <ClientSideEvents SelectedIndexChanged="function(s,e){ PremiumFinancingPopupQuote.PerformCallback();}" />
                                                                                                        ...
                                                                                                        <td>
                                                                                                            <dx:ASPxRadioButtonList ID="PremiumFinanceLenQuote" runat="Server" ClientInstanceName="PremiumFinanceLenQuote">
                                                                                                                <Items>
                                                                                        ...
                                                                                        <td>
                                                                                            <table>
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="Label175" runat="server" Text="Annual Premium: " CssClass="AR_Application"></asp:Label>&nbsp;
                                                                                                        </td>
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralPremiumQuote" runat="server" Casing="Normal" CssClass="AR_Application" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                            <asp:Label ID="Label176" runat="server" Text="Down Payment: " CssClass="AR_Application"></asp:Label>
                                                                                                        </td>
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralDownPaymentQuote" runat="server" Casing="Normal" CssClass="AR_Application" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralAmountFinancedQuote" runat="server" Casing="Normal" CssClass="AR_Application" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralFinanceChargeQuote" runat="server" Casing="Normal" CssClass="AR_Application" />
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralTotalOfPaymentsQuote" runat="server" CssClass="AR_Application"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralMonthlyPaymentQuote" runat="server" CssClass="AR_Application"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                    <tr>
                                                                                                        <td>
                                                                                                        ...
                                                                                                        <td align="right">
                                                                                                            <asp:Label ID="lblGeneralAPRQuote" runat="server" DataFieldName="AnnualRate" CssClass="AR_Application"></asp:Label>
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </tbody>
                                                                                            </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    &nbsp;
                                                                     <dx:ASPxPopupControl ID="ASPxPopupControl2" runat="server" PopupElementID="btnShow" HeaderText="Package Calculations" PopupVerticalAlign="Below" PopupHorizontalAlign="LeftSides" AllowDragging="True"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="left">
                                                                    ...
                                                                    &nbsp;
                                                                     <dx:ASPxPopupControl ID="ASPxPopupControl3" runat="server" PopupElementID="Button1" HeaderText="Standard Calculations" PopupVerticalAlign="Below" PopupHorizontalAlign="LeftSides" AllowDragging="True"
                                                                          MaxWidth="800px" MaxHeight="1800px" MinHeight="150px" MinWidth="150px" ShowFooter="True" >
                                                                         <ContentCollection>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    &nbsp;
                                                                     <dx:ASPxPopupControl ID="ASPxPopupControl4" runat="server" PopupElementID="Button2" HeaderText="Package Calculations" PopupVerticalAlign="Below" PopupHorizontalAlign="LeftSides" AllowDragging="True"
                                                                          MaxWidth="800px" MaxHeight="1800px" MinHeight="150px" MinWidth="150px" ShowFooter="True" >
                                                                         <ContentCollection>
                                                                             <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server">
                                                                                 <asp:Panel ID="Panel2" runat="server">
                                                                                     <table border="0" cellpadding="4" cellspacing="0">
                                                                                         <tr>
                                                                                             <td valign="top">
                                                                                                 <asp:Label ID="AR3_Debug" runat="server" ClientIDMode="Static" Text=""></asp:Label>
                                                                                             </td>
                                                                                         </tr>
                                                                                     </table>
                                                                                 </asp:Panel>
       ...
       <%-- Notes--%>
       <table id="quotenote" runat="server" width="100%">
        <tr style="border-bottom: 1px; border-bottom-color: Black">
            <td colspan="2" align="left">
                <span class="style3">Notes:</span>
            </td>
        </tr>
        <tr>
        <td>
            <dx:ASPxMemo ID="txtquotennotes" runat="server" Height="71px" Width="100%">
            </dx:ASPxMemo>
        </td>
        </tr>
       </table>
        ...
        <asp:Panel ID="PremiumCheckerPanel" runat="server" CssClass="modalPopup" Width="100%"
            Style="display: none">
            <div style="padding: 5px">
            ...
            <div style="padding: 5px">
                <div style="font-size: 10pt">
                    ...
                    <asp:Label ID="AR3_Debug" runat="server" ClientIDMode="Static" Style="display: none"
                        Text=""></asp:Label>
                         <br />--%>
                    <asp:Label ID="originaldte" runat="server" ClientIDMode="Static" Style="display: none"
                        Text=""></asp:Label>
                    <br/>
        ...
        <asp:Panel ID="FinancePopup" runat="server" CssClass="modalPopup" Width="100%" ClientIDMode="Static"
            ...
            <dx:PopupControlContentControl ID="PopupControlContentControl6" runat="server" SupportsDisabledAttribute="True">
                ...
                <asp:Button ID="FinUpdateBtn" runat="server" CausesValidation="false" Text="Update" />
    ...
    <div id="btndatehide" style="display: none">
        <asp:Button ID="btndate" runat="server" Text="Button"/>
        <asp:Button ID="btnloss" runat="server" Text="" Height="0px" Width="0px" Style="display: none" />
     <asp:Label ID="aegisterritorylbl" runat="server" Text="0"  Style="display: none"></asp:Label>
    </div>
</asp:Content>
