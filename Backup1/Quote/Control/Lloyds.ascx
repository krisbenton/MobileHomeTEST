                                            ...
                                            <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <ClientSideEvents SelectedIndexChanged="function(s,e){var txt = PremiumFinanceLen.GetSelectedItem().text;var n = txt.length; if(n>0){PremiumFinancingPopup.PerformCallback();}else{}}" />
                                                    ...
                                                    <dx:ASPxRadioButtonList ID="PremiumFinanceLen" runat="Server" ClientInstanceName="PremiumFinanceLen">
                                                        ...
                                                        <ClientSideEvents SelectedIndexChanged="function(s,e){var txt = PremiumFinanceDP.GetSelectedItem().text;var n = txt.length; if(n>0){PremiumFinancingPopup.PerformCallback();}else{}}" />
                                                        </dx:ASPxRadioButtonList>
