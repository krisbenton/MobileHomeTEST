...
Public Class Lloyds
    ...
    Public Sub WMJStandCalc(ByVal ds As DataSet)
        ...
        End If
            ...
            If CInt(txt_pp_wmj1.Text) > CInt(MHValuelbl.Text * 0.5) Then
                txt_pp_wmj1_Amount.Text = ds.Tables("tbl1").Rows(0).Item("Contents").ToString().Replace("$", "") ' * (txt_pp_wmj1.Text / 100)
        ...
        Else
            ...
            'dd_aop_08_Amount.Text = ds.Tables("tbl1").Rows(0).Item("AOP").ToString().Replace("$", "")
            dd_aop_wmj1_Amount.Text = "(" & CInt(smhtotal * 0.07) & ")"
            smhtotal -= CInt(smhtotal * 0.07)
            WMJopt -= CInt(smhtotal * 0.07)
            WMJcredit += CInt(smhtotal * 0.07)
        End If
    ...
    Protected Sub PrimeRateFinancing()
        ...
        Dim DetailString As String
        If Request.QueryString("quoteID") <> "" Then
            DetailString = fin.CalcFinancingOnlyXML(quoteIDlbl.Text, Nothing)
