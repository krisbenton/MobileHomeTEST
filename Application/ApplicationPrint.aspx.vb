...
Public Class ApplicationPrint
    ...
    Public Sub PrintApplication(ByVal ds As System.Data.DataSet, ByVal ds2 As System.Data.DataSet, ByVal ds3 As System.Data.DataSet, ByVal ds4 As System.Data.DataSet)
        ...
        Try
            ...
            'Added per Vickie 11/3/2013

            myFileStream = New FileStream(Me.MapPath("~\ApplicationPages\") & "PDF\FloodInsuranceWaiverForm.pdf", FileMode.Open, FileAccess.Read)
            'Dim form As New TallComponents.PDF.Document(myFileStream)
            mySourcePDF = New TallComponents.PDF.Document(myFileStream)
            myPDFFields.Pages.AddRange(mySourcePDF.Pages.CloneToArray())
            '  Dim form As New TallComponents.PDF.Document(myFileStream)
            ...
            DirectCast(pdffield, TallComponents.PDF.Forms.Fields.TextField).Value = UCase("XXX-XX-" & ds.Tables(0).Rows(0).Item("SSN").ToString().Substring(5, 4)) 'ds.Tables(0).Rows(0).Item("SSN").ToString()
            ...
            End Select
            'protected
            If IsNumeric(ds.Tables(0).Rows(0).Item("protClass").ToString()) Then


                If CInt(ds.Tables(0).Rows(0).Item("protClass").ToString()) > 0 And CInt(ds.Tables(0).Rows(0).Item("protClass").ToString()) < 9 Then
                    pdffield = myPDFFields.Fields("undefined_9")
                    DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On
                ElseIf CInt(ds.Tables(0).Rows(0).Item("protClass").ToString()) = 9 And ds.Tables(0).Rows(0).Item("ParkStatus").ToString() = "Yes" Then
                    pdffield = myPDFFields.Fields("undefined_9")
                    DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On
                ElseIf CInt(ds.Tables(0).Rows(0).Item("protClass").ToString()) >= 10 And ds.Tables(0).Rows(0).Item("ParkStatus").ToString() = "Yes" Then
                    pdffield = myPDFFields.Fields("undefined_9")
                    DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On
                Else
            ...
            If ds.Tables(0).Rows(0).Item("ParkStatus").ToString() = "Yes" Then
                ...
                DirectCast(rpdffield, TallComponents.PDF.Forms.Fields.RadioButtonField).RadioButtonValue = rpdffield.Options(0)
                If ds.Tables(0).Rows(0).Item("NumOfSpaces").ToString() <> "" Then
            ...
            If ds.Tables(0).Rows(0).Item("SupHeating").ToString() = "Yes" Then

                Select Case ds.Tables(0).Rows(0).Item("suppHeatingType").ToString()
                   
                   
                    Case "Woodstove installed by a licensed contractor"
                        pdffield = myPDFFields.Fields("Woodburning Stove")
                        DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On
                        rpdffield = myPDFFields.Fields("Is the unit factory installed")
                        DirectCast(rpdffield, TallComponents.PDF.Forms.Fields.RadioButtonField).RadioButtonValue = rpdffield.Options(0)
                    Case "Woodstove installed by someone other than a licensed contractor"
                        pdffield = myPDFFields.Fields("Woodburning Stove")
                        DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On


                    Case "Fireplace installed by the manufacturer or licensed contractor"
                        pdffield = myPDFFields.Fields("Fireplace")
                        DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On
                        rpdffield = myPDFFields.Fields("Is the unit factory installed")
                        DirectCast(rpdffield, TallComponents.PDF.Forms.Fields.RadioButtonField).RadioButtonValue = rpdffield.Options(0)
                    Case "Fireplace installed by someone other than the manufacturer or a licensed contractor"
                        pdffield = myPDFFields.Fields("Fireplace")
                        DirectCast(pdffield, TallComponents.PDF.Forms.Fields.CheckBoxField).CheckBoxValue = CheckState.On
            ...
            If ds2.Tables(0).Rows.Count > 0 Then
                ...
                pdffield = myPDFFields.Fields("fill_74")
                DirectCast(pdffield, TallComponents.PDF.Forms.Fields.TextField).Value = subheat
                'DedPrem
