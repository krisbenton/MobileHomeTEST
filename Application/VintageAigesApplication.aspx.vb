...
Public Class VintageAigesApplication
    ...
    Protected Sub save()
        ...
        cmd.Parameters.Add("@ARIng26", SqlDbType.VarChar, 8000).Value = "" ' dd_ARIng25.SelectedItem.Text
    ...
    Protected Sub printApp(ByVal sender As Object, ByVal e As EventArgs) Handles printBtn.Click
        ...
        Else
            ...
            If txtAppNumber.Text <> "" Then
                Common.AjaxOpenWindow(Me.Page, "VintageAegisApplicationPrint.aspx?AppID=" & txtAppNumber.Text, Nothing)
                ...
                Try
                    ...
                    If txtAppNumber.Text = "NULL" Or txtAppNumber.Text = "" Then
                        ...
                        If ds.Tables(0).Rows.Count > 0 Then
                            txtAppNumber.Text = ds.Tables(0).Rows(0).Item("ApplicationID").ToString()
                            labelapp.Text = ds.Tables(0).Rows(0).Item("ApplicationID").ToString()
                            Common.AjaxOpenWindow(Me.Page, "VintageAegisApplicationPrint.aspx?AppID=" & ds.Tables(0).Rows(0).Item("ApplicationID").ToString(), Nothing)
                        End If
                    End If
                Catch ex As Exception
                    errortrap("Print Vintage Aegis Application", "Application ID " & txtAppNumber.Text, ex.Message)
                End Try
