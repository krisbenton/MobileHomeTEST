...
Public Class WMJApplication
    ...
    Protected Sub loadData(ByVal quoteID As String)
        ...
        ds = com.runQueryDS("EXEC sp_WMJQuoteAppData '" & quoteID & "'", "ColonialMHConnectionString")
        If ds.Tables(0).Rows.Count > 0 Then
            ...
            If ds.Tables(0).Rows(0).Item("usage").ToString() = "Rental" Then
            ...
            If ds.Tables(0).Rows(0).Item("ApplicationID").ToString() > "" Then
                ...
                txttitleaddress.Text = ds.Tables(0).Rows(0).Item("COAddress").ToString()
                txttitlecity.Text = ds.Tables(0).Rows(0).Item("COCity").ToString()
                txttitlestate.Text = ds.Tables(0).Rows(0).Item("COState").ToString()
                txttitleZip.Text = ds.Tables(0).Rows(0).Item("COZip").ToString()
                ...
                ARIng25a.Text = ds.Tables(0).Rows(0).Item("ARIng25a").ToString()
                ...
                ddfulltimeStatus.SelectedItem = ddfulltimeStatus.Items.FindByText(ds.Tables(0).Rows(0).Item("fulltimestatus").ToString())

                ddfoundation.SelectedItem = ddfoundation.Items.FindByText(ds.Tables(0).Rows(0).Item("foundation").ToString())
                ddskirting.SelectedItem = ddskirting.Items.FindByText(ds.Tables(0).Rows(0).Item("skirting").ToString())
                ddpool.SelectedItem = ddpool.Items.FindByText(ds.Tables(0).Rows(0).Item("pool").ToString())
                txtCoOcc.Text = ds.Tables(0).Rows(0).Item("cooccupation").ToString()

                otherPolicy.Text = ds.Tables(0).Rows(0).Item("otherpolicy").ToString()
                otherpolicyexp.Text = ds.Tables(0).Rows(0).Item("otherexp").ToString()
                PrevPolicyNumber.Text = ds.Tables(0).Rows(0).Item("prevpolicy").ToString()
                ddprofbuilt.SelectedItem = ddprofbuilt.Items.FindByText(ds.Tables(0).Rows(0).Item("profbuilt").ToString())
            ...
            '' ''End If
            If ds.Tables(0).Rows(0).Item("priorloss").ToString() = "Yes" Then
                dd_ARIng14.SelectedItem = dd_ARIng14.Items.FindByText("Yes")
            Else
                dd_ARIng14.SelectedItem = dd_ARIng14.Items.FindByText("No")
            End If
            If ds.Tables(0).Rows(0).Item("suppHeating").ToString() = "Yes" Then
                dd_ARIng15.SelectedItem = dd_ARIng15.Items.FindByText("Yes")
            Else
                dd_ARIng15.SelectedItem = dd_ARIng15.Items.FindByText("No")
            End If

            If ds.Tables(0).Rows(0).Item("suppHeatingType").ToString() = "Kerosene Heater" Then
                dd_ARIng16.SelectedItem = dd_ARIng16.Items.FindByText("Yes")
            Else
                dd_ARIng16.SelectedItem = dd_ARIng16.Items.FindByText("No")
            End If
            ...
            If ds.Tables(0).Rows(0).Item("usage").ToString() = "Seasonal" Then

            Else

                dd_ARIng20.Enabled = False
                dd_ARIng21.Enabled = False
                dd_ARIng22.Enabled = False
                dd_ARIng23.Enabled = False
                dd_ARIng24.Enabled = False
            End If
    ...
    Protected Sub validateme()
        ...
        val = "ELIGIBLE"
        UWstr = "<table> <tbody>"
        If ddMHAge.SelectedItem.Text = "16 Yrs & Older" Then
            UWstr += "<tr align=left><td>Submit to UW – Contact The Colonial Group at 1-800-628-3762.</td><td>Age of Home is 16 yrs or Older</td></tr> "
            If val = "ELIGIBLE" Then
                val = "Submit to UW"
            End If
        End If
        ...
        If dd_ARIng1.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>1.   Is the home without utility service or not easily accessible from public roadways?</td></tr> "

            If val = "ELIGIBLE" Or val = "Submit to UW" Then
                val = "INELIGIBLE"
            End If
        End If
        If dd_ARIng2.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>2.  Is the home located in an area subject to flooding, mudslides, brush fires, or high crime?</td></tr> "
        ...
        If dd_ARIng3.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>3.   Is the home vacant or unoccupied for more than 6 months? (Seasonal/secondary risks are acceptable)</td></tr> "
        ...
        If dd_ARIng4.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>4.   Is the home two or more singlewides joined together?</td></tr> "
        ...
        If dd_ARIng5.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>5.   Is the home used as rental?</td></tr> "
        ...
        If dd_ARIng6.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>6.   Is the home under any construction or have any existing damage?</td></tr> "
        ...
        If dd_ARIng7.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>7.   Are any commercial business, childcare, or farming activities conducted on the premises?</td></tr> "
        ...
        If dd_ARIng8.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>8.  Is there a swimming pool*, trampoline or similar hazards located on the premises?</td></tr> "
        ...
        If dd_ARIng9.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>9.   Are there any entrances to the home missing permanently installed steps?</td></tr> "
        ...
        If dd_ARIng10.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>10.   Are there any areas on the premises with three or more steps lacking a handrail?</td></tr> "
        ...
        If dd_ARIng11.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>11.   Has any applicant had a foreclosure or repossession or filed bankruptcy in the past 5 years or behind in mortgage payments?</td></tr> "
        ...
        If dd_ARIng12.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>12.   Has any applicant been convicted of arson or fraud?</td></tr> "
        ...
        If dd_ARIng13.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>13.   Is the applicant unemployed (other than retired or disabled)?</td></tr> "
        ...
        If dd_ARIng14.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>14.   Has any applicant had a fire, liability, theft loss or more than 2 losses of any type at any location during the past 5 years?</td></tr> "
        ...
        If dd_ARIng15.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>15.   Does the home have wood, coal or pellet burning stoves, heaters or fireplaces used for supplemental heating that are not Factory installed?</td></tr> "
        ...
        If dd_ARIng16.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>16.   Are there any kerosene heaters on the premises?</td></tr> "
        ...
        If dd_ARIng17.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>17.  Does the insured own or care for any animal with a prior bite history or has shown aggressive behavior towards any person or animal?</td></tr> "
        ...
        If dd_ARIng18.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>18.   Does the insured own or care for any mixed or pure bred dog containing one of the following breeds;  Doberman, German Shepherd, Pit Bull, Rottweiler, Husky, Malamute, Chow, or Akita? </td></tr> "
        ...
        If dd_ARIng19.SelectedItem.Text = "Yes" Then
            UWstr += "<tr align=left><td>Ineligible</td><td>19.   Are there any horses or livestock on the premises? </td></tr> "

            If val = "ELIGIBLE" Or val = "Submit to UW" Then
                val = "INELIGIBLE"
            End If
        End If
        If ddUsage.SelectedItem.Text = "Seasonal" Then


            If dd_ARIng20.SelectedItem.Text = "Yes" Then
                UWstr += "<tr align=left><td>Ineligible</td><td>21.  Is the Home ever Rented? </td></tr> "
            ...
            If dd_ARIng21.SelectedItem.Text = "No" Then
                UWstr += "<tr align=left><td>Ineligible</td><td>22.  Is it within 5 road miles of fire department? </td></tr> "

                If val = "ELIGIBLE" Or val = "Submit to UW" Then
                    val = "INELIGIBLE"
                End If
            End If
            If dd_ARIng22.SelectedItem.Text = "No" Then
                UWstr += "<tr align=left><td>Ineligible</td><td>23.  Is it within 500 feet and sight of two full time residients? </td></tr> "

                If val = "ELIGIBLE" Or val = "Submit to UW" Then
                    val = "INELIGIBLE"
                End If
            End If
            If dd_ARIng23.SelectedItem.Text = "No" Then
                UWstr += "<tr align=left><td>Ineligible</td><td>24.  Is it winterized to prevent freezing or is heat maintained at a minimum of 55F and the main water supply shut off where it enters the residence while unoccupied? </td></tr> "
            ...
            If dd_ARIng24.SelectedItem.Text = "No" Then
                UWstr += "<tr align=left><td>Ineligible</td><td>25.  Is the home entered by the insured or his representive at least once every 30 days? </td></tr> "
        ...
        ' ''    UWstr += "<tr align=left><td>Submit to UW – Contact The Colonial Group at 1-800-628-3762.</td><td>21.  Is there a supplemental heat source in the manufactured home, attached/unattached structure or anywhere on the premises?  If it is a wood, coal, pellet, etc. stove, an WMJ woodstove report must be completed and submitted for approval.</td></tr> "
        ...
        dd_ARIng1.ValidationSettings.RequiredField.ErrorText = "1.   Is the home without utility service or not easily accessible from public roadways?"
        ...
        dd_ARIng2.ValidationSettings.RequiredField.ErrorText = "2.  Is the home located in an area subject to flooding, mudslides, brush fires, or high crime? "
        ...
        dd_ARIng3.ValidationSettings.RequiredField.ErrorText = "3.   Is the home vacant or unoccupied for more than 6 months? (Seasonal/secondary risks are acceptable)"
        ...
        dd_ARIng4.ValidationSettings.RequiredField.ErrorText = "4.   Is the home two or more singlewides joined together?"
        ...
        dd_ARIng5.ValidationSettings.RequiredField.ErrorText = "5.   Is the home used as rental?"
        ...
        dd_ARIng6.ValidationSettings.RequiredField.ErrorText = "6.   Is the home under any construction or have any existing damage?"
        ...
        dd_ARIng7.ValidationSettings.RequiredField.ErrorText = "7.   Are any commercial business, childcare, or farming activities conducted on the premises?"
        ...
        dd_ARIng8.ValidationSettings.RequiredField.ErrorText = "8.  Is there a swimming pool*, trampoline or similar hazards located on the premises?"
        ...
        dd_ARIng9.ValidationSettings.RequiredField.ErrorText = "9.   Are there any entrances to the home missing permanently installed steps? "
        ...
        dd_ARIng10.ValidationSettings.RequiredField.ErrorText = "10.   Are there any areas on the premises with three or more steps lacking a handrail?  "
        ...
        dd_ARIng11.ValidationSettings.RequiredField.ErrorText = "11.   Has any applicant had a foreclosure or repossession or filed bankruptcy in the past 5 years or behind in mortgage payments?"
        ...
        dd_ARIng12.ValidationSettings.RequiredField.ErrorText = "12.   Has any applicant been convicted of arson or fraud?"
        ...
        dd_ARIng13.ValidationSettings.RequiredField.ErrorText = "13.   Is the applicant unemployed (other than retired or disabled)?"
        ...
        dd_ARIng14.ValidationSettings.RequiredField.ErrorText = "14.   Has any applicant had a fire, liability, theft loss or more than 2 losses of any type at any location during the past 5 years?"
        ...
        dd_ARIng15.ValidationSettings.RequiredField.ErrorText = "15.   Does the home have wood, coal or pellet burning stoves, heaters or fireplaces used for supplemental heating that are not Factory installed??"
        ...
        dd_ARIng16.ValidationSettings.RequiredField.ErrorText = "16.   Are there any kerosene heaters on the premises?"
        ...
        dd_ARIng17.ValidationSettings.RequiredField.ErrorText = "17.  Does the insured own or care for any animal with a prior bite history or has shown aggressive behavior towards any person or animal?"
        ...
        dd_ARIng18.ValidationSettings.RequiredField.ErrorText = "18.   Does the insured own or care for any mixed or pure bred dog containing one of the following breeds;  Doberman, German Shepherd, Pit Bull, Rottweiler, Husky, Malamute, Chow, or Akita? "
        ...
        dd_ARIng19.ValidationSettings.RequiredField.ErrorText = "19.   Are there any horses or livestock on the premises? "
        ...
        If ddUsage.SelectedItem.Text = "Seasonal" Then
            ...
            dd_ARIng20.ValidationSettings.RequiredField.ErrorText = "21.  Is the Home ever Rented?"
            ...
            dd_ARIng21.ValidationSettings.RequiredField.ErrorText = "22.  Is it within 5 road miles of fire department?"
            ...
            dd_ARIng22.ValidationSettings.RequiredField.ErrorText = "23.  Is it within 500 feet and sight of two full time residients?"
            ...
            dd_ARIng23.ValidationSettings.RequiredField.ErrorText = "24.  Is it winterized to prevent freezing or is heat maintained at a minimum of 55F and the main water supply shut off where it enters the residence while unoccupied?"
            ...
            dd_ARIng24.ValidationSettings.RequiredField.ErrorText = "25.  Is the home entered by the insured or his representive at least once every 30 days?"
    ...
    Private Sub getTerritory1(ByVal county As String)
        ...
        Dim conn As New SqlConnection(dbConn)
        Dim cmd As New SqlCommand("SELECT * from WMJTerritory where county = '" & county & "' ", conn)
    ...
    Protected Sub save()
        ...
        Dim cmd As New SqlCommand("sp_WMJAppSave", dbConnection)
        ...
        cmd.Parameters.Add("@ARIng25a", SqlDbType.VarChar, 8000).Value = ARIng25a.Text
        ...
        cmd.Parameters.Add("@fulltimestatus", SqlDbType.VarChar, 8000).Value = ddfulltimeStatus.SelectedItem.Text
        cmd.Parameters.Add("@foundation", SqlDbType.VarChar, 8000).Value = ddfoundation.SelectedItem.Text
        cmd.Parameters.Add("@skirting", SqlDbType.VarChar, 8000).Value = ddskirting.SelectedItem.Text
        cmd.Parameters.Add("@pool", SqlDbType.VarChar, 8000).Value = ddpool.SelectedItem.Text
        cmd.Parameters.Add("@cooccupation", SqlDbType.VarChar, 8000).Value = txtCoOcc.Text

        cmd.Parameters.Add("@otherpolicy", SqlDbType.VarChar, 8000).Value = otherPolicy.Text
        cmd.Parameters.Add("@otherexp", SqlDbType.VarChar, 8000).Value = otherpolicyexp.Text
        cmd.Parameters.Add("@prevpolicy", SqlDbType.VarChar, 8000).Value = PrevPolicyNumber.Text
        cmd.Parameters.Add("@profbuilt", SqlDbType.VarChar, 8000).Value = ddprofbuilt.SelectedItem.Text
        cmd.Parameters.Add("@CoAddress", SqlDbType.VarChar, 8000).Value = txttitleaddress.Text
        cmd.Parameters.Add("@CoCity", SqlDbType.VarChar, 8000).Value = txttitlecity.Text
        cmd.Parameters.Add("@Costate", SqlDbType.VarChar, 8000).Value = txttitlestate.Text
        cmd.Parameters.Add("@CoZip", SqlDbType.VarChar, 8000).Value = txttitleZip.Text
        ...
        Catch ex As Exception
            ...
            Next
            errortrap("WMJ Save " & s, "Save WMJ Application", ex.Message)
    ...
    Protected Sub printApp(ByVal sender As Object, ByVal e As EventArgs) Handles printBtn.Click
        ...
        Else
            ...
            If txtAppNumber.Text <> "" Then
                Common.AjaxOpenWindow(Me.Page, "WMJApplicationPrint.aspx?AppID=" & txtAppNumber.Text, Nothing)
            ...
            Else
                Try
                    ...
                    If txtAppNumber.Text = "NULL" Or txtAppNumber.Text = "" Then
                        ds = com.runQueryDS("SELECT TOP 1 ApplicationID FROM tblWMJApplication where quoteid = " & txtQuoteID.Text & " ORDER BY ApplicationID DESC", "ColonialMHConnectionString")
                        If ds.Tables(0).Rows.Count > 0 Then
                            txtAppNumber.Text = ds.Tables(0).Rows(0).Item("ApplicationID").ToString()
                            labelapp.Text = ds.Tables(0).Rows(0).Item("ApplicationID").ToString()
                            Common.AjaxOpenWindow(Me.Page, "WMJApplicationPrint.aspx?AppID=" & ds.Tables(0).Rows(0).Item("ApplicationID").ToString(), Nothing)
                        End If
                    End If
                Catch ex As Exception
                    errortrap("Print WMJ Application", "Application ID " & txtAppNumber.Text, ex.Message)
                End Try
    ...
    Private Sub errortrap(ByVal sqlcomm As String, ByVal appsub As String, ByVal errormsg As String)
        ...
        cmd.Parameters.Add("@Page", SqlDbType.VarChar, 50).Value = "WMJ Application"
        ...
        If OVreasontxt.Text.Length > 2 Then
            ...
            Else
                Try
                    ...
                    End If
                Catch ex As Exception
                    errortrap("Print WMJ Application OverRide", "Application ID " & txtAppNumber.Text, ex.Message)
                End Try
