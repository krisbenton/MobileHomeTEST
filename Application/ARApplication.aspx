                    ...
                    Information">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtOcc" runat="server" Text="" TabIndex="4"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtSpouseDOB" runat="server" Text="" TabIndex="8"></asp:TextBox>
                                </td>
                            </tr>
                             <tr>
                                ...
                                <td align="left">
                                    <asp:DropDownList runat="Server" ID="addlInsuredcheck" TabIndex="9">
                            ...
                            <tr id="addlins1" style="display: none">
                                ...
                                <td>
                                    <asp:TextBox style="text-transform:uppercase" ID="txtAddInsured" runat="server" 
                                ...
                                <td colspan="3">
                                    <asp:TextBox style="text-transform:uppercase" ID="txtAddAddress" Width="100%" 
                            ...
                            <td align="right">
                                ...
                                <td>
                                    <asp:TextBox ID="txtaddzip" runat="server" Width="50px" Text="" TabIndex="12"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox style="text-transform:uppercase" ID="txtaddcity" runat="server" 
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox style="text-transform:uppercase" ID="txtDiffAppAddr" Width="100%" 
                                        runat="server" Text="" TabIndex="16"></asp:TextBox>
                            ...
                            <td align="right">
                                ...
                                <td>
                                    <asp:TextBox style="text-transform:uppercase" ID="txtDiffAppCity" 
                                        runat="server" Text="" TabIndex="18" ></asp:TextBox>
                                    </td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox style="text-transform:uppercase" ID="txtAddress" Width="100%" 
                                        runat="server" Text="" TabIndex="20"  ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            <td align="right">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox style="text-transform:uppercase" ID="txtMunTaxCode" runat="server" 
                                        Text="" TabIndex="23"></asp:TextBox>
                                </td>
                                <hr />
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtDistToFireDept" runat="server" Text="" 
                                        WatermarkText="Miles" TabIndex="25"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox style="text-transform:uppercase" ID="txtFireDeptName" 
                                        runat="server" Text="" TabIndex="26"></asp:TextBox>
